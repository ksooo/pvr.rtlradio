...
#include "dsp_dab/profiling.h"
#include "dsp_dab/decoders/decoder_adapter.h"
#include "dsp_dab/decoders/eep_protection.h"
#include "dsp_dab/decoders/uep_protection.h"
    ...
    dumpFileName(dumpFileName)
{
    ...
    if (protection.shortForm) {
        protectionHandler = make_aligned<UEPProtection>(bitRate, protection.uepLevel);
    }
    else {
        const bool profile_is_eep_a =
            protection.eepProfile == EEPProtectionProfile::EEP_A;
        protectionHandler = make_aligned<EEPProtection>(
