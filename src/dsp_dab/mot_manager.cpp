...
bool MOTObject::ParseCheckHeader(MOT_FILE& target_file)
{
  ...
  bool header_update = content_type == MOT_FILE::CONTENT_TYPE_MOT_TRANSPORT &&
...
bool MOTManager::ParseCheckDataGroupHeader(const std::vector<uint8_t>& dg,
                                           size_t& offset,
                                           int& dg_type)
{
...
bool MOTManager::ParseCheckSessionHeader(const std::vector<uint8_t>& dg,
                                         size_t& offset,
                                         bool& last_seg,
                                         int& seg_number,
                                         int& transport_id)
...
bool MOTManager::ParseCheckSegmentationHeader(const std::vector<uint8_t>& dg,
                                              size_t& offset,
                                              size_t& seg_size)
{
